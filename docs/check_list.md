...
Open the branch's test link and sign in. You should see the amber banner "Test
version. Nothing you change here is saved" and "Not saved" where the live app
says "Saved". If you do not, stop: you are on the live app.
...
data rather than a fixed rate. The comparison table in BUILD_PROGRESS.md sets
out how much each of those moved the September plan.
...
5. Check the method and glossary pages read the way you would say it.
6. Press "PDF, no notes" and confirm only the notes page is missing.
...
4. **Setup, market guide.** Check the months read sensibly against what you
...
2. Open `/archive/` on the live address. It should show the amber archive
   banner and the plans as they were before the release. Open one and export
   its PDF; compare it with the copy taken from the live app before the merge
   (step 3 of `docs/release.md`).
